...
import MarkupVisualizer from '@/components/Visualizer/MarkupVisualizer'
...
const PhotoForm: React.FC<PhotoFormProps> = observer(
  ({ onClose, currentPhoto, setCurrentPhoto, project, onChange }) => {
    ...
    return (
      <>
        {showVisualizer && currentPhoto && (
          <MarkupVisualizer
            setShowVisualizer={setShowVisualizer}
            project={project}
            currentPhoto={currentPhoto}
            updateCurrentPhotoImage={(photoUrl: string) => {
              setCurrentPhoto({ ...currentPhoto, photoUrl })
            }}
          ></MarkupVisualizer>
        )}
        {!showVisualizer && (
