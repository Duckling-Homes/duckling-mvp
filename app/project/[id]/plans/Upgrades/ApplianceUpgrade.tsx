...
const ApplianceUpgrades: React.FC<ApplianceUgpradesProps> = ({ catalogue }) => {
  ...
  function addWorkItem(item: CatalogueItem) {
    ...
    const newWorkItemsList: CatalogueItem[] = workItems
  ...
  function removeWorkItem(itemCustomId: string | undefined) {
    ...
    newWorkItemsList = newWorkItemsList.filter((item: CatalogueItem) => item.customId !== itemCustomId)
    setWorkItems(newWorkItemsList)
  }
